...
### Aliases: ForecastData-class initialize,ForecastData-method
...
##D slot(.forecastData, "predCalibration")
##D slot(.forecastData, "OutcomeCalibration")
##D slot(.forecastData, "predTest")
##D slot(.forecastData, "outcomeTest")
##D slot(.forecastData, "modelNames")
##D 
##D ### to assign individual slots, use set functions or the slot function
##D 
...
##D slot(.forecastData, "modelNames")
##D 
##D ### to assign individual slots, use set functions or slot function
##D 
##D setPredCalibration(this.ForecastData)<-calibrationSample[,c("LMER", "SAE", "GLM")]
##D setOutcomeCalibration(this.ForecastData)<-calibrationSample[,"Insurgency"]
##D setPredTest(this.ForecastData)<-testSample[,c("LMER", "SAE", "GLM")]
