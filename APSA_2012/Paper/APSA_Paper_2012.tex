...
\begin{tabular}{rrrrr}
  \toprule
   \multicolumn{5}{c}{Number of Models}\\
 & 1 --10& 11-30 & 31--60 & $>60$ \\ 
  \midrule
...
\end{center}
\label{compareTable2}
The table shows EBMA's relative performance, as measured by eight forecasting metrics, to each of its components against the number of forecasts generated by the component models.  
Rows show the number of metrics EBMA scores better on than each of the models, while the columns show the number of predictions made by these models. 
\end{table}
