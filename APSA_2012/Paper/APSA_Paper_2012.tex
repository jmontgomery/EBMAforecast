...
A second and related issue is dimensionality. Many predictive examples
contain many more forecasts than observations.  For example, the
...
A additional issue is the inconsistency with which forecasts are
...
means  determined by $f_k^{t^\ast}$ and scaled by the
model weights $w_k$.
...
{\LARGE What is this word? Supposed to be?} 
{\bf temas}
is apparent in the \textit{Survey of Professional Forecasters
...
{\LARGE \bf Jacob, c=0 looks the same as c=,05; is this a rounding issue?}
...
{\Large \bf Jacob/Flo: Why are these results different than symposium. Perhaps a footnote?}
...
{\bf \Large  Figure 3 has a typo and why are the predictions out of phase with the Observed?}
 \newpage
 \appendix
 ...
 \mathrm{PW} &=& \frac{\sum_1^nI(e_i > b_i)}{n}
\end{eqnarray*}
