...
increased chance that EBMA may incorrectly weight component models in a way
...
identifiability. We leave that to future work in which we plan to rewrite the EBMA algorithm
...
Ensembles are a useful approach to aggregation of predictive information. Even a decade ago
there was not a lot of predictive information in need of aggregation in the social sciences. With the 
advent of newer approaches, more widely available data, and predictive heuristics the arena of 
predictive forecasts is expanded considerably. Using the EBMA approach not only is now feasible
in the social sciences, but is increasingly useful.
